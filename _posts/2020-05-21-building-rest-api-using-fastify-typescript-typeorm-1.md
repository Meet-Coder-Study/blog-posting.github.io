...
![src/index.ts](/assets/image/building-rest-api-using-fastify-typescript-typeorm-1/1.png 'src/index.ts')
...
4. 데이터베이스 연결하기  
   ...
   ![memo table](/assets/image/building-rest-api-using-fastify-typescript-typeorm-1/2.png 'memo table')
