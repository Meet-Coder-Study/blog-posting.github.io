---
title: fastify.js, typeORM, typescript 를 이용한 RESTful API 만들기 - (2) Route 생성, Middleware,
  Handler 작성
layout: post
...
2.  http request 만들기  
    ...
    ![memo http](/assets/image/building-rest-api-using-fastify-typescript-typeorm-2/1.png 'memo http')
...
![로그인 응답 예시](/assets/image/building-rest-api-using-fastify-typescript-typeorm-2/2.png '로그인 응답 예시')

아래 예시의 id=2, id=3 인 memo 는 id=1 인 사용자만 접근 가능합니다. 회원가입, 로그인 및 메모 Create, Read, Update, Delete 가 잘 작동됨을 확인할 수 있습니다.

![user table](/assets/image/building-rest-api-using-fastify-typescript-typeorm-2/3.png 'user table')
![memo table](/assets/image/building-rest-api-using-fastify-typescript-typeorm-2/4.png 'memo table')
